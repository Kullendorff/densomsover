...
12 NPC-bilder är klara i wiki_data.js men **bildfiler saknas** i repot:
- `Mivell_Thamrin.png` - Tempelledare, lila kläder med bok
...
- `Sheikh_Nabil.png` - Gammal eremit vid oas, bönepärlor
- `Rimklo.png` - Massiv vit isbjörn, rytande
- `Radslingan.png` - Skuggvarelse ur grotta/mörker
- `Sankt_Astrid.png` - Blond flicka, ber, vildblommor, by
