# EON Karaktärsreferens

**KRITISK FIL:** Läs ALLTID denna fil FÖRST innan du uppdaterar kampanjdata!
...
**KRITISKT:** Dessa namn är SAMMA person, inte olika karaktärer!
...
## OFFER TILL YELGOTHA (Älvakungen/Själabäraren)

**Passage till Skugglandet krävde fem offer (Kapitel 9):**

1. **Thrakka:** Traumatiska minnen (gladiatoråren, slaveriet, smärtan)
2. **Umnatak:** Säkerhet/trygghet
3. **Gordon:** Generositet
4. **Arcadius/Corvus:** Skuld (skapade bokstavligt hål i bröstet)
5. **Kazrik:** Ambition/girighet

**Konsekvenser:** Varje offer lämnade ett tomrum i själen. Arcadius mest påverkad (fysiskt hål).

---

## VIKTIGA NPCs MED KÖN

**KRITISKT:** Använd rätt pronomen!
...
- [ ] Corvus/Arcadius = tempelriddare, kastar ALDRIG magi
...
1. Dokumentera kön direkt i detta dokument
2. Använd rätt pronomen i alla filer
3. Om osäker på kön: FRÅGA användaren

**När du beskriver strider/skador:**
1. Verifiera mot denna referens
2. Använd korrekta skadenamn
3. Aldrig gissa - fråga om osäker

**När du använder karaktärsnamn:**
1. Kolla alias-listan
2. Fråga vilket namn som passar om osäker
3. Var konsekvent inom samma dokument

---

**DENNA FIL ÄR LEVANDE - UPPDATERA NÄR KAMPANJEN VÄXER!**

**LÄGG TILL:**
- Nya NPCs med kön
- Nya alias-mappningar
